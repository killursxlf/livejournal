...
import type { Post as PostDTO } from "@/types/type";
import type { Post, CommentData } from "@/types/type";
...
function transformAuthor(author: Post["author"]): AuthorUI {
  return {
...
function transformComment(comment: CommentData): CommentUI {
  return {
    id: comment.id,
    content: comment.content,
    date: new Date(comment.createdAt).toISOString(),
    author: comment.author.name,
    authorId: comment.author.id ?? comment.author.username,
    authorUserName: comment.author.username,
    avatar: comment.author.avatar,
  };
}

function transformPost(post: Post): PostUI {
  return {
    id: post.id,
    title: post.title,
